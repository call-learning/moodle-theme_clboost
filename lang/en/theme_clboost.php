...
$string['ganalytics_policy_trigger'] = 'Google Analytics Trigger';
$string['ganalytics_policy_trigger_desc'] = 'Google Analytics will only be enabled if the policy has been accepted';
$string['hasnavdrawer'] = 'Has nav drawer ?';
